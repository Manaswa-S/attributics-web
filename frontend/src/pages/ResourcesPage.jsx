...
const ResourcesPage = () => {
    ...
    const filteredResources = useMemo(() => {
        ...
        return items.filter(item => item.id !== featuredItem?.id);
    ...
    return (
        <>
            ...
            {featuredItem && (
                <section className={`${commonMB}`}>
                    <a className="block group" href={featuredItem.link} target="_blank" rel="noopener noreferrer">
            ...
            <div className="prose prose-lg max-w-none">
                <div
                    dangerouslySetInnerHTML={{ __html: filteredResources.find(item => item)?.content || '' }}
                />
            </div> */}

...
const Hero = () => {
  ...
  fill="url(#ribbon1)"
  initial={{
    d: "M0,100 C320,300 420,0 720,100 C1020,200 1120,0 1440,100 L1440,400 L0,400 Z"
  }}
  animate={{
    d: [
...
<motion.path 
  fill="url(#ribbon2)"
  initial={{
    d: "M0,250 C200,100 500,350 800,200 C1100,50 1300,250 1440,150 L1440,400 L0,400 Z"
  }}
  animate={{
    d: [
...
<motion.path 
  ...
  strokeWidth="1"
  initial={{
    d: "M0,100 C320,300 420,0 720,100 C1020,200 1120,0 1440,100"
  }}
  animate={{
    d: [
...
<motion.path 
  ...
  strokeWidth="2"
  initial={{
    d: "M0,250 C200,100 500,350 800,200 C1100,50 1300,250 1440,150"
  }}
  animate={{
    d: [

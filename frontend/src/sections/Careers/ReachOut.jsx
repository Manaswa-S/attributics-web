    ...
    return (
        <>
            ...
            <section className="container mx-auto px-6 max-w-4xl mb-20 text-center">
                ...
                <h2 className="section-title text-4xl md:text-6xl font-display font-extrabold tracking-tight text-slate-900 mb-2">
                    Build the <span className="text-[#FF5A36]">Intelligence Layer</span>
                </h2>
                <h2 className="section-title text-4xl md:text-6xl font-display font-extrabold tracking-tight text-slate-900 mb-8">
                    Behind Modern Retention.
                </h2>
                <p className="section-description text-slate-600 text-lg mb-10 max-w-2xl mx-auto">
